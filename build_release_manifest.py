...
def build() -> dict:
    ...
    payload = {
        ...
        "role_contract": {
            ...
            "benevente2": "Estratégia principal em acompanhamento: preserva a cesta anual e reduz exposição após estresse observável no fechamento anterior.",
        },
        "evaluation": {
        ...
        "limitations": [
            ...
            "A camada de risco do Benevente 2 é retrospectiva; o imposto intranual é uma estimativa agregada, não uma conciliação por lote e nota de corretagem.",
        ],
