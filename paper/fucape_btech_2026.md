...
|---|---:|---:|---:|---:|---:|:---:|
| Ultraconservador | 4% | 12 | 9,73% | 0,74% | −0,81% | 8 de 11 |
...
Os quatro perfis preservam a ordenação declarada de risco: retorno e queda máxima crescem juntos do ultraconservador ao arrojado, e nenhum se aproximou da queda máxima do Ibovespa. Só o ultraconservador fica abaixo do índice, o esperado de uma carteira com 4% em ações.
...
A coluna em reais traduz a taxa anualizada em escala econômica. Esses valores dependem da qualidade da série reconstruída e devem ser lidos junto com a Seção 5.2.
