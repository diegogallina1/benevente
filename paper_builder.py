...
\section{Value and quality extension}The next experimental module defines a point-in-time fundamental data contract and applies deterministic eligibility filters before portfolio construction. It excludes illiquid issuers, firms without positive free-cash-flow yield, and non-financial firms with weak ROIC, excessive leverage, or inadequate interest coverage. An LLM may provide a structured, skeptical thesis review of already eligible candidates, but cannot output portfolio weights or override hard filters. This extension requires a historically dated fundamental-data source before empirical claims are made.
